...
exports.book_create_post = [
  ...
  body("title")
    ...
    .isAlpha().withMessage("Title must be in letters")
    .escape(),
...
exports.book_delete_post = (req, res, next) => {
  ...
  async.parallel({
    ...
    if (results.instances.length > 0){
      res.render('book_delete', { title: 'Delete book', book: results.book, bookInstances: results.instances });
      return;
    }
  ...
  // get instances
  // if no book redirect
  // if instances redirect to book
  // remove & redirect to books
};
